...
import com.example.calcultor.MainActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    @SuppressLint("SetTextI18n")
    public void btn_sin_inv(View view) {
        sign = "sin_inv";
        user_input.setText(null);
        has_Dot = false;
        sign_Box.setText("sin-1");
    }
    @SuppressLint("SetTextI18n")
    public void btn_cos_inv(View view) {
        sign = "cos_inv";
        user_input.setText(null);
        has_Dot = false;
        sign_Box.setText("cos-1");
    }
        ...
        if (sign == null) {
            ...
            switch (sign) {
                ...
                case "sin_inv":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText((Math.asin((num1)) + ""));
                    sign = null;
                    sign_Box.setText(null);
                    break;
                case "cos_inv":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText((Math.acos((num1)) + ""));
                    sign = null;
                    sign_Box.setText(null);
                    break;
                case "cos":
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId())
        {
            ...
            case R.id.inv_trigo:
                ...
                return true;
            case R.id.other:
                Toast.makeText(this,"It is selected",Toast.LENGTH_SHORT).show();
                return true;
            default:
